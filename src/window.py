...
class Window(Gtk.Window):
    def __init__(self, db_manager, user, book, list_chapters):
        ...
        self.list_rect_progress_bar = [
            ...
            ChapterRectangle(self.pb_start_x, self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 114),
            ChapterRectangle(self.pb_start_x +1*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 113),
            ChapterRectangle(self.pb_start_x +2*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 112),
            ChapterRectangle(self.pb_start_x +3*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 111),
            ChapterRectangle(self.pb_start_x +4*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 110),
            ChapterRectangle(self.pb_start_x +5*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 109),
            ChapterRectangle(self.pb_start_x +6*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 108),
            ChapterRectangle(self.pb_start_x +7*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 107),
            ChapterRectangle(self.pb_start_x +8*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 106),
            ChapterRectangle(self.pb_start_x +9*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 105),
            ChapterRectangle(self.pb_start_x+10*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 104),
            ChapterRectangle(self.pb_start_x+11*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 103),
            ChapterRectangle(self.pb_start_x+12*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 102),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 101),
            ChapterRectangle(self.pb_start_x+14*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 100),
            ChapterRectangle(self.pb_start_x+15*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 99),
            ChapterRectangle(self.pb_start_x+16*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 98),
            ChapterRectangle(self.pb_start_x+17*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 97),
            ChapterRectangle(self.pb_start_x+18*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 96),
            ChapterRectangle(self.pb_start_x+19*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 95),
            ChapterRectangle(self.pb_start_x+20*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 94),
            ChapterRectangle(self.pb_start_x+21*(self.pb_hd+16), self.pb_start_y + self.pb_vd*30, 16, self.pb_start_h, 93),
