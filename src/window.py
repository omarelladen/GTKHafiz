...
class Window(Gtk.Window):
    def __init__(self, db_manager, user, book, list_chapters):
        ...
        self.list_rect_progress_bar = [
            ...
            ChapterRectangle(self.pb_start_x,                    self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 114),
            ChapterRectangle(self.pb_start_x +1*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 113),
            ChapterRectangle(self.pb_start_x +2*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 112),
            ChapterRectangle(self.pb_start_x +3*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 111),
            ChapterRectangle(self.pb_start_x +4*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 110),
            ChapterRectangle(self.pb_start_x +5*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 109),
            ChapterRectangle(self.pb_start_x +6*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 108),
            ChapterRectangle(self.pb_start_x +7*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 107),
            ChapterRectangle(self.pb_start_x +8*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 106),
            ChapterRectangle(self.pb_start_x +9*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 105),
            ChapterRectangle(self.pb_start_x+10*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 104),
            ChapterRectangle(self.pb_start_x+11*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 103),
            ChapterRectangle(self.pb_start_x+12*(self.pb_hd+11), self.pb_start_y + self.pb_vd*30, 11, self.pb_start_h, 102),

            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)                  , self.pb_start_y + self.pb_vd*30, 14, self.pb_start_h, 101),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+1*self.pb_hd+1*14, self.pb_start_y + self.pb_vd*30, 14, self.pb_start_h, 100),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+2*self.pb_hd+2*14, self.pb_start_y + self.pb_vd*30, 14, self.pb_start_h, 99),

            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+3*self.pb_hd+3*14, self.pb_start_y + self.pb_vd*30, 35, self.pb_start_h, 98),

            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+4*self.pb_hd+3*14+35, self.pb_start_y + self.pb_vd*30, 12, self.pb_start_h, 97),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+5*self.pb_hd+3*14+35+12, self.pb_start_y + self.pb_vd*30, 20, self.pb_start_h, 96),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+6*self.pb_hd+3*14+35+12+20, self.pb_start_y + self.pb_vd*30, 14, self.pb_start_h, 95),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+7*self.pb_hd+3*14+35+12+20+14, self.pb_start_y + self.pb_vd*30, 12, self.pb_start_h, 94),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+8*self.pb_hd+3*14+35+12+20+14+12, self.pb_start_y + self.pb_vd*30, 14, self.pb_start_h, 93),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+9*self.pb_hd+3*14+35+12+20+14+12+14, self.pb_start_y + self.pb_vd*30, 20, self.pb_start_h, 92),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+10*self.pb_hd+3*14+35+12+20+14+12+14+20, self.pb_start_y + self.pb_vd*30, 20, self.pb_start_h, 91),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+11*self.pb_hd+3*14+35+12+20+14+12+14+2*20, self.pb_start_y + self.pb_vd*30, 25, self.pb_start_h, 90),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+12*self.pb_hd+3*14+35+12+20+14+12+14+2*20+25, self.pb_start_y + self.pb_vd*30, 35, self.pb_start_h, 89),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+13*self.pb_hd+3*14+35+12+20+14+12+14+2*20+25+35, self.pb_start_y + self.pb_vd*30, 30, self.pb_start_h, 88),
            ChapterRectangle(self.pb_start_x+13*(self.pb_hd+11)+14*self.pb_hd+3*14+35+12+20+14+12+14+2*20+25+35+30, self.pb_start_y + self.pb_vd*30, 24, self.pb_start_h, 87),
        ]
